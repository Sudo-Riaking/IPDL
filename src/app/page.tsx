...
const EXPLORE_LINKS = [
  ...
  { href: "/logiciels", title: "Logiciels", desc: "Plateformes de modélisation et simulation open source reconnues mondialement.", Icon: Code2, accent: "text-purple-400", bg: "bg-purple-500/10" },
