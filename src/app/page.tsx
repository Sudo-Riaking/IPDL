...
// Quick links to the dedicated pages — keeps the homepage light and routes the
// visitor to the full feature pages instead of stacking everything on "/".
const EXPLORE_LINKS = [
  {
    href: "/publications",
    title: "Publications",
    desc: "Recherche multicritère, citations APA/BibTeX, liens Google Scholar & DOI.",
    Icon: BookOpen,
  ...
  {
    href: "/datasets",
    title: "Datasets ouverts",
    desc: "Catalogue à 3 niveaux d'accès (public, protégé, privé) avec licences.",
    Icon: Database,
  ...
  {
    href: "/equipe",
    title: "Équipe & chercheurs",
    desc: "94 membres, 5 centres internationaux, vitrines personnelles.",
    Icon: Users,
  ...
  },
  {
    href: "/simulations",
    title: "Simulations",
    desc: "Modèles intégrés (GAMA, NetLogo) exécutables sans quitter le portail.",
    Icon: FlaskConical,
  ...
  {
    href: "/actualites",
    title: "Actualités & séminaires",
    desc: "Agenda scientifique, inscriptions en ligne, contrats de doctorat.",
    Icon: Newspaper,
  ...
  },
  {
    ...
    desc: "Tutelles, partenaires académiques, financeurs et applications liées.",
    Icon: Handshake,
...
export default function Home() {
  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-950 text-slate-100 font-sans">
      {/* ── HERO ──────────────────────────────────────────────────────────── */}
      <section className="relative flex flex-col justify-center min-h-[78vh] py-20 px-4 sm:px-6 lg:px-8 overflow-hidden border-b border-slate-900">
        ...
        <div className="mx-auto max-w-4xl text-center relative z-10 flex flex-col items-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-1.5 rounded-full border border-slate-800 bg-slate-900/60 px-3.5 py-1 text-sm text-slate-400 mt-6"
          >
          ...
          <motion.h1
            ...
            className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-6xl mt-6"
          >
          ...
          <motion.p
            ...
            className="mt-6 max-w-2xl text-slate-400 text-base leading-relaxed"
          >
            {t("hero.description")}
          </motion.p>
            ...
            {q && (
              <div className="absolute top-full left-0 right-0 mt-3 rounded-2xl border border-slate-800 bg-slate-900/95 backdrop-blur-md shadow-2xl p-6 text-left z-30 max-h-96 overflow-y-auto">
                <div className="flex items-center justify-between pb-3 border-b border-slate-800 mb-4">
                  ...
                  <button onClick={() => setSearchQuery("")} className="text-[13px] text-slate-400 hover:text-slate-200">
                    {t("hero.searchClear")}
                  </button>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {filteredResearchers.map((r) => (
                          <Link key={r.id} href={`/chercheurs/${r.id}`} className="block p-2 rounded-lg hover:bg-slate-800/60 transition-colors">
                  ...
                  {filteredPubs.length > 0 && (
                    <div>
                      ...
                      <div className="space-y-2">
                        {filteredPubs.map((p) => (
                          <Link key={p.id} href="/publications" className="block p-2 rounded-lg hover:bg-slate-800/60 transition-colors">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {filteredDatasets.map((d) => (
                          <Link key={d.id} href="/datasets" className="block p-2 rounded-lg hover:bg-slate-800/60 transition-colors">
                  ...
                  {filteredResearchers.length === 0 && filteredPubs.length === 0 && filteredDatasets.length === 0 && (
                    <div className="text-sm text-slate-500 text-center py-4">
                      {t("hero.searchNoResult")} «&nbsp;{searchQuery}&nbsp;».
                    </div>
                  )}
                </div>
              </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-12">
            ...
            <p className="mt-4 max-w-2xl text-slate-400 text-base leading-relaxed">
              Les travaux d&apos;UMMISCO se structurent autour de quatre axes alliant modélisation fondamentale et applications concrètes de terrain.
            </p>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {AXES.map((axis) => (
              <button
                ...
                className={`text-left cursor-pointer rounded-xl border p-6 transition-all duration-300 flex flex-col justify-between min-h-48 ${
                  selectedAxis === axis.id
                    ? "border-blue-500 bg-slate-900/60 shadow-lg shadow-blue-500/5 -translate-y-1"
                    : "border-slate-800 bg-slate-900/10 hover:border-slate-700 hover:bg-slate-900/20"
                }`}
              >
                <div>
                  <div className={`h-2 w-10 rounded-full bg-gradient-to-r ${axis.color} mb-4`} />
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-wrap gap-4 justify-between items-end">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <Quote className="h-3.5 w-3.5" /> Google Scholar <ExternalLink className="h-3 w-3" />
              </a>
              <Link href="/publications" className="inline-flex items-center gap-1 text-sm font-semibold text-blue-400 hover:text-blue-300">
                ...
                <div>
                  <div className="flex justify-between items-center mb-4">
                    <span className="inline-flex items-center rounded-full bg-slate-900 px-2 py-0.5 text-[12px] font-semibold text-slate-400 border border-slate-800 uppercase tracking-wider">
                      {AXES.find((a) => a.id === pub.axis)?.shortName}
                    </span>
                ...
                <div className="mt-6 pt-4 border-t border-slate-900/60">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 rounded bg-slate-900 px-2.5 py-1.5 text-[12px] font-bold text-slate-300 border border-slate-800 hover:border-slate-700 hover:text-white transition-all"
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 rounded bg-blue-600/10 px-2.5 py-1.5 text-[12px] font-bold text-blue-400 border border-blue-900/30 hover:bg-blue-600/20 active:scale-95 transition-all"
                    >
                      <Clipboard className="h-3 w-3" /> {t("publications.cite")}
                    </button>
                  </div>
                </div>
              </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 border-b border-slate-900">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12">
            <span className="text-[13px] mono-text uppercase tracking-widest text-slate-500 font-bold block mb-2">
            ...
            <p className="mt-4 max-w-2xl text-slate-400 text-base leading-relaxed">
              Chaque espace est une application complète : publications référencées, datasets contrôlés, simulations intégrées et vie scientifique du laboratoire.
            </p>
          </div>
            ...
            {EXPLORE_LINKS.map((item) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className="group rounded-xl border border-slate-800 bg-slate-900/10 p-6 hover:border-slate-700 hover:bg-slate-900/30 transition-all flex flex-col"
                >
                  <span className={`flex h-11 w-11 items-center justify-center rounded-xl ${item.bg} ${item.accent} mb-4`}>
                  ...
                  <span className="mt-4 inline-flex items-center gap-1 text-[13px] font-semibold text-slate-400 group-hover:text-slate-200">
                    Découvrir <ArrowRight className="h-3 w-3 group-hover:translate-x-0.5 transition-transform" />
                  </span>
                </Link>
              );
            })}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 border-b border-slate-900 bg-slate-900/10">
        <div className="mx-auto max-w-5xl rounded-2xl border border-slate-900 bg-gradient-to-br from-blue-950/40 to-slate-900/20 p-8 sm:p-10 flex flex-col sm:flex-row items-start sm:items-center gap-6 justify-between">
          <div className="max-w-2xl">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold text-white">Assistant IA UMMISCO</h3>
            </div>
            <p className="text-sm text-slate-400 leading-relaxed">
              Posez vos questions sur nos axes, publications, datasets, chercheurs et événements. L&apos;assistant scientifique répond en français ou en anglais, 24h/24.
            </p>
          </div>
          <div className="text-[13px] text-slate-500 flex items-center gap-2 whitespace-nowrap">
          ...
          >
            ...
            >
              <div className="flex items-center justify-between pb-3 border-b border-slate-800 mb-6">
                ...
                <button onClick={() => setCitationModalPub(null)} className="text-sm text-slate-500 hover:text-slate-200">
                  {t("common.close")}
                </button>
              </div>
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  <div className="flex justify-between items-center text-[13px] font-bold text-slate-500 uppercase tracking-wider">
                    ...
                    <button onClick={() => handleCopyCitation(citationModalPub.citationApa, "apa")} className="inline-flex items-center gap-1 hover:text-white">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center text-[13px] font-bold text-slate-500 uppercase tracking-wider">
                    ...
                    <button onClick={() => handleCopyCitation(citationModalPub.citationBibtex, "bibtex")} className="inline-flex items-center gap-1 hover:text-white">
                ...
                <div className="flex flex-wrap gap-3 pt-2">
                  <a href={scholarUrl(citationModalPub)} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded-lg bg-slate-950 px-4 py-2 text-[13px] font-bold text-slate-300 border border-slate-800 hover:text-white">
                    <Quote className="h-3.5 w-3.5" /> Ouvrir dans Google Scholar
                  </a>
                  {doiUrl(citationModalPub.doi) && (
                    <a href={doiUrl(citationModalPub.doi)} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded-lg bg-slate-950 px-4 py-2 text-[13px] font-bold text-slate-300 border border-slate-800 hover:text-white">
                      <ExternalLink className="h-3.5 w-3.5" /> Page de l&apos;éditeur (DOI)
                    </a>
                  )}
                </div>
              </div>
